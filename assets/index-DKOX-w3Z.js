...
const useSwitchsanityKong = (id2, normal) => {
  const [dk2, diddy, lanky, tiny, chunky, isSwitchsanity, switches] = useDonkStore(
    useShallow((state) => [
      state.dk,
      state.diddy,
      state.lanky,
...
const useIslesCrossFungi = () => {
  ...
  const [dk2, diddy, rocket, tiny, twirl, chunky] = useDonkStore(
    useShallow((state) => [
      state.dk,
      state.diddy,
      state.rocket,
...
const useIslesKremTop = () => {
  const [tiny, port, dk2, blast, lanky, balloon, isSwitchsanity, switches] = useDonkStore(
    useShallow((state) => [
      state.tiny,
      state.port,
      state.dk,
...
const IslesShops = () => {
  const [dk2, diddy, lanky, tiny, chunky, poolShops] = useDonkStore(
    useShallow((state) => [
      state.dk,
      state.diddy,
      state.lanky,
  ...
  const anyKong = dk2 || diddy || lanky || tiny || chunky;
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(jsxRuntimeExports.Fragment, { children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx(IslesCheck, { id: 110, name: "Isles Cranky Shared", region: "Isles Shops", canGetLogic: anyKong }),
    /* @__PURE__ */ jsxRuntimeExports.jsx(IslesCheck, { id: 111, name: "Isles Cranky DK", region: "Isles Shops", canGetLogic: dk2 }),
    /* @__PURE__ */ jsxRuntimeExports.jsx(IslesCheck, { id: 112, name: "Isles Cranky Diddy", region: "Isles Shops", canGetLogic: diddy }),
    /* @__PURE__ */ jsxRuntimeExports.jsx(IslesCheck, { id: 113, name: "Isles Cranky Lanky", region: "Isles Shops", canGetLogic: lanky }),
    /* @__PURE__ */ jsxRuntimeExports.jsx(IslesCheck, { id: 114, name: "Isles Cranky Tiny", region: "Isles Shops", canGetLogic: tiny }),
    /* @__PURE__ */ jsxRuntimeExports.jsx(IslesCheck, { id: 115, name: "Isles Cranky Chunky", region: "Isles Shops", canGetLogic: chunky })
  ] });
};
...
const useJapesPaintingOutside = () => {
  const inStage = usePlayJapes();
  const [dk2, lanky, stand, tiny, twirl, chunky] = useDonkStore(
    useShallow((state) => [
      state.dk,
      state.lanky,
      state.stand,
...
const useAztecGuitarSwitch = () => useSwitchsanityMusicPad("aztecGuitar", 1);
...
const useAztecTinyTemple = () => {
  ...
  const properGun = diddy && peanut || lanky && grape || tiny && feather || chunky && pineapple;
  return {
...
const useFactoryProductionEnabled = () => {
  const inStage = usePlayFactory();
  const [dk2, coconut, grab, removeBarriers] = useDonkStore(
    useShallow((state) => [state.dk, state.coconut, state.grab, state.removeBarriers])
  );
  return inStage && (removeBarriers.factoryProduction || dk2 && coconut && grab);
};
...
const useGalleonLighthousePlatform = () => {
  ...
  return {
    in: bananaport == 2 || lighthouseArea && (highTide || removeBarriers.galleonSeasick && tiny && twirl),
...
const useGalleonSeasickShip = () => {
  ...
  const [removeBarriers, dk2, grab] = useDonkStore(
    useShallow((state) => [state.removeBarriers, state.dk, state.grab])
  );
  return {
    in: lighthouseArea && removeBarriers.galleonSeasick || lighthousePlatform.in && canSlam && dk2 && grab,
    out: logicBreak(lighthousePlatform) && canSlam && dk2 && grab
  };
};
...
const useCavesPillar = () => {
  const inStage = usePlayCaves();
  const [dk2, diddy, rocket, lanky, balloon, tiny, twirl, bananaport] = useDonkStore(
    useShallow((state) => [
      state.dk,
      state.diddy,
      state.rocket,
  ...
  return {
    ...
    out: inStage && (dk2 || tiny && twirl || lanky && balloon)
  };
};
...
const useCastleTree = () => {
  ...
  const [dk2, blast] = useDonkStore(useShallow((state) => [state.dk, state.blast]));
  return inStage && dk2 && blast;
};
const ArenaPool = ({ children }) => {
  const pool = useDonkStore(useShallow((state) => state.poolCrowns));
  return pool ? /* @__PURE__ */ jsxRuntimeExports.jsx(jsxRuntimeExports.Fragment, { children }) : null;
};
const ToughGoldenBanana = ({ children }) => {
...
const DirtAztec = () => {
  ...
  const islesUpper = useIslesUpper();
  const boulderTech = useBoulderTech();
  const [dk2, diddy, rocket, tiny, twirl, shockwave, dirtShuffle, rainbowCoinShuffle] = useDonkStore(
    useShallow((state) => [
      state.dk,
      state.diddy,
      state.rocket,
...
const RainbowCoinPool = ({ children }) => {
...
const DirtLocations$7 = () => {
  ...
  const locations = shuffle ? /* @__PURE__ */ jsxRuntimeExports.jsx(ShuffledDirtLocations$7, {}) : /* @__PURE__ */ jsxRuntimeExports.jsx(VanillaDirtLocations$7, {});
  return /* @__PURE__ */ jsxRuntimeExports.jsx(RainbowCoinPool, { children: locations });
};
const KasplatPool = ({ children }) => {
...
const KasplatLocations$7 = () => {
  ...
  const locations = shuffle ? /* @__PURE__ */ jsxRuntimeExports.jsx(Shuffled$m, {}) : /* @__PURE__ */ jsxRuntimeExports.jsx(Vanilla$m, {});
  return /* @__PURE__ */ jsxRuntimeExports.jsx(KasplatPool, { children: locations });
};
const CompanyPool = ({ children }) => {
...
const FairyLocations$7 = () => {
  ...
  const locations = shuffle ? /* @__PURE__ */ jsxRuntimeExports.jsx(Shuffled$l, {}) : /* @__PURE__ */ jsxRuntimeExports.jsx(Vanilla$l, {});
  return /* @__PURE__ */ jsxRuntimeExports.jsx(FairyPool, { children: locations });
};
const CratePool = ({ children }) => {
  const pool = useDonkStore(useShallow((state) => state.poolCrates));
  return pool ? /* @__PURE__ */ jsxRuntimeExports.jsx(jsxRuntimeExports.Fragment, { children }) : null;
};
const Vanilla$k = () => null;
const Shuffled$k = () => {
  const anyKong = useAnyKong();
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(jsxRuntimeExports.Fragment, { children: [
...
const CrateLocations$6 = () => {
  ...
  const locations = shuffle ? /* @__PURE__ */ jsxRuntimeExports.jsx(Shuffled$k, {}) : /* @__PURE__ */ jsxRuntimeExports.jsx(Vanilla$k, {});
...
const IsleChecks = () => {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "grid", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx(IslesCheck, { id: 1, name: "Isles DK Japes Rock", region: "Main Isle", canGetLogic: anyKong }),
    /* @__PURE__ */ jsxRuntimeExports.jsx(
      IslesCheck,
      {
        id: 2,
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx(
      IslesCheck,
      {
        ...
        canGetBreak: key4 && peanut && (dk2 || tiny && twirl)
      }
    ),
    /* @__PURE__ */ jsxRuntimeExports.jsx(
      IslesCheck,
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx(IslesCheck, { id: 20, name: "Isles Lanky Caged Banana", region: "Krem Isle", canGetLogic: grape }),
    /* @__PURE__ */ jsxRuntimeExports.jsx(
      IslesCheck,
      {
        id: 21,
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs(ArenaPool, { children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx(
        IslesCheck,
        {
          id: 90,
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx(IslesShops, {})
  ] });
};
...
const DkMedal$6 = () => {
  ...
  const [cbCount, coloredBananaShuffle, dk2, coconut, blast, vine] = useDonkStore(
    useShallow((state) => [
      state.cbCount,
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsx(
    JapesCheck,
    {
      ...
      canGetLogic: inStage && dk2 && (coloredBananaShuffle || currLogic >= cbCount),
      canGetBreak: inStage && dk2 && (coloredBananaShuffle || currBreak >= cbCount)
    }
  );
};
const DiddyMedal$6 = () => {
...
const BananaMedalPool = ({ children }) => {
...
const DirtLocations$6 = () => {
  const shuffle = useDonkStore(useShallow((state) => state.shuffleDirt));
  const locations = shuffle ? /* @__PURE__ */ jsxRuntimeExports.jsx(ShuffledDirtLocations$6, {}) : /* @__PURE__ */ jsxRuntimeExports.jsx(VanillaDirtLocations$6, {});
  return /* @__PURE__ */ jsxRuntimeExports.jsx(RainbowCoinPool, { children: locations });
};
const Vanilla$j = () => {
  const inStage = usePlayJapes();
  ...
  const [dk2, diddy, tiny, twirl, pineapple, vine] = useDonkStore(
    useShallow((state) => [
      state.dk,
      state.diddy,
      state.tiny,
...
const KasplatLocations$6 = () => {
  const shuffle = useDonkStore(useShallow((state) => state.shuffleKasplats));
  const locations = shuffle ? /* @__PURE__ */ jsxRuntimeExports.jsx(Shuffled$j, {}) : /* @__PURE__ */ jsxRuntimeExports.jsx(Vanilla$j, {});
  return /* @__PURE__ */ jsxRuntimeExports.jsx(KasplatPool, { children: locations });
};
const BossPool = ({ children }) => {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(jsxRuntimeExports.Fragment, { children: [
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx(
      JapesCheck,
      {
        ...
        canGetBreak: lanky && slam != 0 && japesPaintingInside.out && (anyGun || anyMusic) && camera
      }
    )
  ] });
};
...
const FairyLocations$6 = () => {
  const shuffle = useDonkStore(useShallow((state) => state.shuffleFairies));
  const locations = shuffle ? /* @__PURE__ */ jsxRuntimeExports.jsx(Shuffled$i, {}) : /* @__PURE__ */ jsxRuntimeExports.jsx(Vanilla$i, {});
  return /* @__PURE__ */ jsxRuntimeExports.jsx(FairyPool, { children: locations });
};
const Vanilla$h = () => {
  const inStage = usePlayJapes();
...
const CrateLocations$5 = () => {
  const shuffle = useDonkStore(useShallow((state) => state.shuffleCrates));
  const locations = shuffle ? /* @__PURE__ */ jsxRuntimeExports.jsx(Shuffled$h, {}) : /* @__PURE__ */ jsxRuntimeExports.jsx(Vanilla$h, {});
  return /* @__PURE__ */ jsxRuntimeExports.jsx(CratePool, { children: locations });
};
const JapesChecks = () => {
  const playJapes = usePlayJapes();
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "grid", children: [
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx(
      JapesCheck,
      {
        ...
        region: "Japes Lowlands",
        canGetLogic: playJapes && dk2 && blast && vine
      }
    ),
    /* @__PURE__ */ jsxRuntimeExports.jsx(
      JapesCheck,
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx(
      JapesCheck,
      {
        ...
        canGetBreak: japesUnder && (dk2 || tiny && twirl || (tiny || diddy) && vine)
      }
    ),
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx(ArenaPool, { children: /* @__PURE__ */ jsxRuntimeExports.jsx(
      JapesCheck,
      {
        id: 1090,
        name: "Japes Arena",
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx(JapesShops, {})
  ] });
};
...
const LevelTable = () => {
  return /* @__PURE__ */ jsxRuntimeExports.jsx(jsxRuntimeExports.Fragment, { children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "level-list", children: [
...
const SimpleIcon = (props) => {
  const value = useDonkStore((state) => state[props.storeKey]);
...
const DoubleIcon = (props) => {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "double-icon", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx(
      "img",
      {
        width: 24,
...
const clamp$1 = (num) => Math.min(Math.max(num, 0), 3);
const nextSlam = (num) => clamp$1(num + 1);
const prevSlam = (num) => clamp$1(num - 1);
const SlamSelector = () => {
...
const MoveTable = () => {
  return /* @__PURE__ */ jsxRuntimeExports.jsx("table", { className: "move-table", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("tbody", { children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs("tr", { children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("td", { children: /* @__PURE__ */ jsxRuntimeExports.jsx(SimpleIcon, { storeKey: "dk", imgUrl: dkKongIcon }) }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("td", { children: /* @__PURE__ */ jsxRuntimeExports.jsx(SimpleIcon, { storeKey: "coconut", imgUrl: dkGunIcon }) }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("td", { children: /* @__PURE__ */ jsxRuntimeExports.jsx(SimpleIcon, { storeKey: "bongos", imgUrl: dkMusicIcon }) }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("td", { children: /* @__PURE__ */ jsxRuntimeExports.jsx(SimpleIcon, { storeKey: "grab", imgUrl: dkMoveIcon }) }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("td", { children: /* @__PURE__ */ jsxRuntimeExports.jsx(SimpleIcon, { storeKey: "strong", imgUrl: dkBarrelIcon }) }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("td", { children: /* @__PURE__ */ jsxRuntimeExports.jsx(SimpleIcon, { storeKey: "blast", imgUrl: dkPadIcon }) }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("td", { children: /* @__PURE__ */ jsxRuntimeExports.jsx(SlamSelector, {}) }),
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsx("td", { children: /* @__PURE__ */ jsxRuntimeExports.jsx(CountSelector, { storeKey: "crowns", imgUrl: crownIcon, maxValue: 10 }) })
    ] }),
    /* @__PURE__ */ jsxRuntimeExports.jsxs("tr", { children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("td", { children: /* @__PURE__ */ jsxRuntimeExports.jsx(SimpleIcon, { storeKey: "diddy", imgUrl: diddyKongIcon }) }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("td", { children: /* @__PURE__ */ jsxRuntimeExports.jsx(SimpleIcon, { storeKey: "peanut", imgUrl: diddyGunIcon }) }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("td", { children: /* @__PURE__ */ jsxRuntimeExports.jsx(SimpleIcon, { storeKey: "guitar", imgUrl: diddyMusicIcon }) }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("td", { children: /* @__PURE__ */ jsxRuntimeExports.jsx(SimpleIcon, { storeKey: "charge", imgUrl: diddyMoveIcon }) }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("td", { children: /* @__PURE__ */ jsxRuntimeExports.jsx(SimpleIcon, { storeKey: "rocket", imgUrl: diddyBarrelIcon }) }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("td", { children: /* @__PURE__ */ jsxRuntimeExports.jsx(SimpleIcon, { storeKey: "spring", imgUrl: diddyPadIcon }) }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("td", { children: /* @__PURE__ */ jsxRuntimeExports.jsx(SimpleIcon, { storeKey: "dive", imgUrl: diveIcon }) }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("td", { children: /* @__PURE__ */ jsxRuntimeExports.jsx(
        DoubleIcon,
        {
          storeLeft: "homing",
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsx("td", { children: /* @__PURE__ */ jsxRuntimeExports.jsx(CountSelector, { storeKey: "bananaMedals", imgUrl: bananaMedalIcon$1, maxValue: 40 }) })
    ] }),
    /* @__PURE__ */ jsxRuntimeExports.jsxs("tr", { children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("td", { children: /* @__PURE__ */ jsxRuntimeExports.jsx(SimpleIcon, { storeKey: "lanky", imgUrl: lankyKongIcon }) }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("td", { children: /* @__PURE__ */ jsxRuntimeExports.jsx(SimpleIcon, { storeKey: "grape", imgUrl: lankyGunIcon }) }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("td", { children: /* @__PURE__ */ jsxRuntimeExports.jsx(SimpleIcon, { storeKey: "trombone", imgUrl: lankyMusicIcon }) }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("td", { children: /* @__PURE__ */ jsxRuntimeExports.jsx(SimpleIcon, { storeKey: "stand", imgUrl: lankyMoveIcon }) }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("td", { children: /* @__PURE__ */ jsxRuntimeExports.jsx(SimpleIcon, { storeKey: "sprint", imgUrl: lankyBarrelIcon }) }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("td", { children: /* @__PURE__ */ jsxRuntimeExports.jsx(SimpleIcon, { storeKey: "balloon", imgUrl: lankyPadIcon }) }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("td", { children: /* @__PURE__ */ jsxRuntimeExports.jsx(SimpleIcon, { storeKey: "orange", imgUrl: orangeIcon }) }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("td", { children: /* @__PURE__ */ jsxRuntimeExports.jsx(
        DoubleIcon,
        {
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsx("td", { children: /* @__PURE__ */ jsxRuntimeExports.jsx(CountSelector, { storeKey: "rainbowCoins", imgUrl: rainbowCoinIcon, maxValue: 16 }) })
    ] }),
    /* @__PURE__ */ jsxRuntimeExports.jsxs("tr", { children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("td", { children: /* @__PURE__ */ jsxRuntimeExports.jsx(SimpleIcon, { storeKey: "tiny", imgUrl: tinyKongIcon }) }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("td", { children: /* @__PURE__ */ jsxRuntimeExports.jsx(SimpleIcon, { storeKey: "feather", imgUrl: tinyGunIcon }) }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("td", { children: /* @__PURE__ */ jsxRuntimeExports.jsx(SimpleIcon, { storeKey: "sax", imgUrl: tinyMusicIcon }) }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("td", { children: /* @__PURE__ */ jsxRuntimeExports.jsx(SimpleIcon, { storeKey: "twirl", imgUrl: tinyMoveIcon }) }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("td", { children: /* @__PURE__ */ jsxRuntimeExports.jsx(SimpleIcon, { storeKey: "mini", imgUrl: tinyBarrelIcon }) }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("td", { children: /* @__PURE__ */ jsxRuntimeExports.jsx(SimpleIcon, { storeKey: "port", imgUrl: tinyPadIcon }) }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("td", { children: /* @__PURE__ */ jsxRuntimeExports.jsx(SimpleIcon, { storeKey: "vine", imgUrl: vineIcon }) }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("td", { children: /* @__PURE__ */ jsxRuntimeExports.jsx(SimpleIcon, { storeKey: "bean", imgUrl: beanIcon }) }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("td", { children: /* @__PURE__ */ jsxRuntimeExports.jsx(CountSelector, { storeKey: "fairies", imgUrl: fairyIcon, maxValue: 20 }) })
    ] }),
    /* @__PURE__ */ jsxRuntimeExports.jsxs("tr", { children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("td", { children: /* @__PURE__ */ jsxRuntimeExports.jsx(SimpleIcon, { storeKey: "chunky", imgUrl: chunkyKongIcon }) }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("td", { children: /* @__PURE__ */ jsxRuntimeExports.jsx(SimpleIcon, { storeKey: "pineapple", imgUrl: chunkyGunIcon }) }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("td", { children: /* @__PURE__ */ jsxRuntimeExports.jsx(SimpleIcon, { storeKey: "triangle", imgUrl: chunkyMusicIcon }) }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("td", { children: /* @__PURE__ */ jsxRuntimeExports.jsx(SimpleIcon, { storeKey: "punch", imgUrl: chunkyMoveIcon }) }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("td", { children: /* @__PURE__ */ jsxRuntimeExports.jsx(SimpleIcon, { storeKey: "hunky", imgUrl: chunkyBarrelIcon }) }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("td", { children: /* @__PURE__ */ jsxRuntimeExports.jsx(SimpleIcon, { storeKey: "gone", imgUrl: chunkyPadIcon }) }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("td", { children: /* @__PURE__ */ jsxRuntimeExports.jsx(SimpleIcon, { storeKey: "barrel", imgUrl: barrelIcon }) }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("td", { children: /* @__PURE__ */ jsxRuntimeExports.jsx(CountSelector, { storeKey: "pearls", imgUrl: pearlIcon, maxValue: 5 }) }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("td", { children: /* @__PURE__ */ jsxRuntimeExports.jsx(CountSelector, { storeKey: "goldBananas", imgUrl: goldBananaIcon, maxValue: 201 }) })
    ] })
  ] }) });
};
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(jsxRuntimeExports.Fragment, { children: [
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx(
      AztecCheck,
      {
        ...
        region: "Aztec Shops",
        canGetLogic: aztecBack.in && dk2,
        canGetBreak: aztecBack.out && dk2
      }
    ),
    /* @__PURE__ */ jsxRuntimeExports.jsx(
      AztecCheck,
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx(
      AztecCheck,
      {
        ...
        name: "Aztec Candy DK",
        region: "Aztec Shops",
        canGetLogic: aztecFront.in && dk2,
        canGetBreak: aztecFront.out && dk2
      }
    ),
    /* @__PURE__ */ jsxRuntimeExports.jsx(
      AztecCheck,
...
const DkMedal$5 = () => {
  ...
  const [cbCount, coloredBananaShuffle, dk2, coconut, strong] = useDonkStore(
    useShallow((state) => [
      state.cbCount,
      state.shuffleColoredBananas,
      state.dk,
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsx(
    AztecCheck,
    {
      ...
      canGetLogic: inStage.in && dk2 && (coloredBananaShuffle || currLogic >= cbCount),
      canGetBreak: logicBreak(inStage) && dk2 && (coloredBananaShuffle || currBreak >= cbCount)
    }
  );
};
const DiddyMedal$5 = () => {
...
const DirtLocations$5 = () => {
  const shuffle = useDonkStore(useShallow((state) => state.shuffleDirt));
  const locations = shuffle ? /* @__PURE__ */ jsxRuntimeExports.jsx(ShuffledDirtLocations$5, {}) : /* @__PURE__ */ jsxRuntimeExports.jsx(VanillaDirtLocations$5, {});
  return /* @__PURE__ */ jsxRuntimeExports.jsx(RainbowCoinPool, { children: locations });
};
const Vanilla$g = () => {
  const aztecFront = useAztecFront();
...
const KasplatLocations$5 = () => {
  const shuffle = useDonkStore(useShallow((state) => state.shuffleKasplats));
  const locations = shuffle ? /* @__PURE__ */ jsxRuntimeExports.jsx(Shuffled$g, {}) : /* @__PURE__ */ jsxRuntimeExports.jsx(Vanilla$g, {});
  return /* @__PURE__ */ jsxRuntimeExports.jsx(KasplatPool, { children: locations });
};
const Vanilla$f = () => {
  const camera = useCamera();
...
const FairyLocations$5 = () => {
  const shuffle = useDonkStore(useShallow((state) => state.shuffleFairies));
  const locations = shuffle ? /* @__PURE__ */ jsxRuntimeExports.jsx(Shuffled$f, {}) : /* @__PURE__ */ jsxRuntimeExports.jsx(Vanilla$f, {});
  return /* @__PURE__ */ jsxRuntimeExports.jsx(FairyPool, { children: locations });
};
const Vanilla$e = () => {
  const llama = useAztecLlamaTemple();
...
const CrateLocations$4 = () => {
  const shuffle = useDonkStore(useShallow((state) => state.shuffleCrates));
  const locations = shuffle ? /* @__PURE__ */ jsxRuntimeExports.jsx(Shuffled$e, {}) : /* @__PURE__ */ jsxRuntimeExports.jsx(Vanilla$e, {});
  return /* @__PURE__ */ jsxRuntimeExports.jsx(CratePool, { children: locations });
};
const AztecChecks = () => {
  const aztecFront = useAztecFront();
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "grid", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx(
      AztecCheck,
      {
        ...
        region: "Aztec Oasis And Totem Area",
        canGetLogic: aztecBack.in && dk2 && blast,
        canGetBreak: aztecBack.out && dk2 && blast
      }
    ),
    /* @__PURE__ */ jsxRuntimeExports.jsx(
      AztecCheck,
      {
        ...
        region: "Various Aztec Tunnels",
        canGetLogic: aztecTunnel.in && dk2 && strong,
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx(
      AztecCheck,
      {
        ...
        region: "5 Door Temple",
        canGetLogic: aztec5Door.in && dk2 && coconut,
        canGetBreak: aztec5Door.out && dk2 && coconut
      }
    ),
    /* @__PURE__ */ jsxRuntimeExports.jsx(
      AztecCheck,
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx(AztecShops, {})
  ] });
};
...
const DkMedal$4 = () => {
  ...
  const [cbCount, coloredBananaShuffle, dk2, coconut, strong, blast] = useDonkStore(
    useShallow((state) => [
      state.cbCount,
      state.shuffleColoredBananas,
      state.dk,
...
const TinyMedal$4 = () => {
  ...
  const production = useFactoryProductionEnabled();
  const prodTop = useFactoryProductionTop();
  const [cbCount, coloredBananaShuffle, kong, gun, move, crystal, dk2] = useDonkStore(
    useShallow((state) => [
      state.cbCount,
      state.shuffleColoredBananas,
      state.tiny,
  ...
  const currBreak = production && dk2 ? currLogic += 5 : currLogic;
  if (production && move) {
    currLogic += 5;
  }
  return /* @__PURE__ */ jsxRuntimeExports.jsx(
...
const DirtLocations$4 = () => {
  const shuffle = useDonkStore(useShallow((state) => state.shuffleDirt));
  const locations = shuffle ? /* @__PURE__ */ jsxRuntimeExports.jsx(ShuffledDirtLocations$4, {}) : /* @__PURE__ */ jsxRuntimeExports.jsx(VanillaDirtLocations$4, {});
  return /* @__PURE__ */ jsxRuntimeExports.jsx(RainbowCoinPool, { children: locations });
};
const Vanilla$d = () => {
  const inStage = usePlayFactory();
...
const KasplatLocations$4 = () => {
  const shuffle = useDonkStore(useShallow((state) => state.shuffleKasplats));
  const locations = shuffle ? /* @__PURE__ */ jsxRuntimeExports.jsx(Shuffled$d, {}) : /* @__PURE__ */ jsxRuntimeExports.jsx(Vanilla$d, {});
  return /* @__PURE__ */ jsxRuntimeExports.jsx(KasplatPool, { children: locations });
};
const Vanilla$c = () => {
  const testing = useFactoryTesting();
...
const FairyLocations$4 = () => {
  const shuffle = useDonkStore(useShallow((state) => state.shuffleFairies));
  const locations = shuffle ? /* @__PURE__ */ jsxRuntimeExports.jsx(Shuffled$c, {}) : /* @__PURE__ */ jsxRuntimeExports.jsx(Vanilla$c, {});
  return /* @__PURE__ */ jsxRuntimeExports.jsx(FairyPool, { children: locations });
};
const FactoryChecks = () => {
  const testing = useFactoryTesting();
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "grid", children: [
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx(
      FactoryCheck,
      {
        ...
        region: "Storage And Arcade",
        canGetLogic: testing && dk2 && coconut
      }
    ),
    /* @__PURE__ */ jsxRuntimeExports.jsx(
      FactoryCheck,
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx(
      FactoryCheck,
      {
        ...
        region: "Production Room",
        canGetLogic: inStage && dk2 && strong,
        canGetBreak: inStage && (dk2 || diddy)
      }
    ),
    /* @__PURE__ */ jsxRuntimeExports.jsx(CompanyPool, { children: /* @__PURE__ */ jsxRuntimeExports.jsx(
      FactoryCheck,
      {
        ...
        region: "Storage And Arcade",
        canGetLogic: inStage && dk2 && blast && grab
      }
    ) }),
    /* @__PURE__ */ jsxRuntimeExports.jsx(
      FactoryCheck,
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx(
      FactoryCheck,
      {
        ...
        canGetBreak: testing && canSlam && diddy && dk2
      }
    ),
    /* @__PURE__ */ jsxRuntimeExports.jsx(
      FactoryCheck,
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx(
      FactoryCheck,
      {
        ...
        canGetBreak: production && (tiny && twirl || dk2)
      }
    ),
    /* @__PURE__ */ jsxRuntimeExports.jsx(
      FactoryCheck,
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx(FactoryShops, {})
  ] });
};
...
const LankyMedal$3 = () => {
  ...
  const [cbCount, coloredBananaShuffle, kong, gun, music, pad, dive, diddy, spring, tiny, twirl] = useDonkStore(
    useShallow((state) => [
      state.cbCount,
      state.shuffleColoredBananas,
      state.lanky,
...
const DirtLocations$3 = () => {
  const shuffle = useDonkStore(useShallow((state) => state.shuffleDirt));
  const locations = shuffle ? /* @__PURE__ */ jsxRuntimeExports.jsx(ShuffledDirtLocations$3, {}) : /* @__PURE__ */ jsxRuntimeExports.jsx(VanillaDirtLocations$3, {});
  return /* @__PURE__ */ jsxRuntimeExports.jsx(RainbowCoinPool, { children: locations });
};
const MiscPool = ({ children }) => {
...
const KasplatLocations$3 = () => {
  const shuffle = useDonkStore(useShallow((state) => state.shuffleKasplats));
  const locations = shuffle ? /* @__PURE__ */ jsxRuntimeExports.jsx(Shuffled$b, {}) : /* @__PURE__ */ jsxRuntimeExports.jsx(Vanilla$b, {});
  return /* @__PURE__ */ jsxRuntimeExports.jsx(KasplatPool, { children: locations });
};
const Vanilla$a = () => {
  const camera = useCamera();
...
const FairyLocations$3 = () => {
  const shuffle = useDonkStore(useShallow((state) => state.shuffleFairies));
  const locations = shuffle ? /* @__PURE__ */ jsxRuntimeExports.jsx(Shuffled$a, {}) : /* @__PURE__ */ jsxRuntimeExports.jsx(Vanilla$a, {});
  return /* @__PURE__ */ jsxRuntimeExports.jsx(FairyPool, { children: locations });
};
const Vanilla$9 = () => {
  const outskirts = useGalleonOutskirts();
...
const CrateLocations$3 = () => {
  const shuffle = useDonkStore(useShallow((state) => state.shuffleCrates));
  const locations = shuffle ? /* @__PURE__ */ jsxRuntimeExports.jsx(Shuffled$9, {}) : /* @__PURE__ */ jsxRuntimeExports.jsx(Vanilla$9, {});
  return /* @__PURE__ */ jsxRuntimeExports.jsx(CratePool, { children: locations });
};
const GalleonChecks = () => {
  const inStage = usePlayGalleon();
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "grid", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx(
      GalleonCheck,
      {
        ...
        region: "Lighthouse Area",
        canGetLogic: lighthouseArea && highTide && canSlam && dk2,
        canGetBreak: lighthouseArea && canSlam && dk2
      }
    ),
    /* @__PURE__ */ jsxRuntimeExports.jsx(
      GalleonCheck,
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx(GalleonShops, {})
  ] });
};
...
const DirtLocations$2 = () => {
  const shuffle = useDonkStore(useShallow((state) => state.shuffleDirt));
  const locations = shuffle ? /* @__PURE__ */ jsxRuntimeExports.jsx(ShuffledDirtLocations$2, {}) : /* @__PURE__ */ jsxRuntimeExports.jsx(VanillaDirtLocations$2, {});
  return /* @__PURE__ */ jsxRuntimeExports.jsx(RainbowCoinPool, { children: locations });
};
const Vanilla$8 = () => {
  const inStage = usePlayForest();
...
const KasplatLocations$2 = () => {
  const shuffle = useDonkStore(useShallow((state) => state.shuffleKasplats));
  const locations = shuffle ? /* @__PURE__ */ jsxRuntimeExports.jsx(Shuffled$8, {}) : /* @__PURE__ */ jsxRuntimeExports.jsx(Vanilla$8, {});
  return /* @__PURE__ */ jsxRuntimeExports.jsx(KasplatPool, { children: locations });
};
const Vanilla$7 = () => {
  const inStage = usePlayForest();
...
const FairyLocations$2 = () => {
  const shuffle = useDonkStore(useShallow((state) => state.shuffleFairies));
  const locations = shuffle ? /* @__PURE__ */ jsxRuntimeExports.jsx(Shuffled$7, {}) : /* @__PURE__ */ jsxRuntimeExports.jsx(Vanilla$7, {});
  return /* @__PURE__ */ jsxRuntimeExports.jsx(FairyPool, { children: locations });
};
const Vanilla$6 = () => {
  const inStage = usePlayForest();
...
const CrateLocations$2 = () => {
  const shuffle = useDonkStore(useShallow((state) => state.shuffleCrates));
  const locations = shuffle ? /* @__PURE__ */ jsxRuntimeExports.jsx(Shuffled$6, {}) : /* @__PURE__ */ jsxRuntimeExports.jsx(Vanilla$6, {});
  return /* @__PURE__ */ jsxRuntimeExports.jsx(CratePool, { children: locations });
};
const ForestChecks = () => {
  const inStage = usePlayForest();
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "grid", children: [
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx(
      ForestCheck,
      {
        ...
        name: "Forest DK Mill",
        region: "Forest Mills",
        canGetLogic: inStage && day.in && night.in && dk2 && canSlam && grab,
        canGetBreak: inStage && day.out && night.out && dk2 && canSlam && grab
      }
    ),
    /* @__PURE__ */ jsxRuntimeExports.jsx(
      ForestCheck,
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx(
      ForestCheck,
      {
        ...
        region: "Forest Mills",
        canGetLogic: inStage && day.in && boulderTech && punch && triangle && dk2 && grab,
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx(ForestShops, {})
  ] });
};
...
const TinyMedal$1 = () => {
  ...
  const punch = usePunch();
  const boulderTech = useBoulderTech();
  const [cbCount, coloredBananaShuffle, kong, gun, music, move, crystal, pad, hunky, bananaport] = useDonkStore(
    useShallow((state) => [
      state.cbCount,
      state.shuffleColoredBananas,
      state.tiny,
...
const DirtLocations$1 = () => {
  const shuffle = useDonkStore(useShallow((state) => state.shuffleDirt));
  const locations = shuffle ? /* @__PURE__ */ jsxRuntimeExports.jsx(ShuffledDirtLocations$1, {}) : /* @__PURE__ */ jsxRuntimeExports.jsx(VanillaDirtLocations$1, {});
  return /* @__PURE__ */ jsxRuntimeExports.jsx(RainbowCoinPool, { children: locations });
};
const Vanilla$5 = () => {
  const inStage = usePlayCaves();
...
const KasplatLocations$1 = () => {
  const shuffle = useDonkStore(useShallow((state) => state.shuffleKasplats));
  const locations = shuffle ? /* @__PURE__ */ jsxRuntimeExports.jsx(Shuffled$5, {}) : /* @__PURE__ */ jsxRuntimeExports.jsx(Vanilla$5, {});
  return /* @__PURE__ */ jsxRuntimeExports.jsx(KasplatPool, { children: locations });
};
const Vanilla$4 = () => {
  const inStage = usePlayCaves();
...
const FairyLocations$1 = () => {
  const shuffle = useDonkStore(useShallow((state) => state.shuffleFairies));
  const locations = shuffle ? /* @__PURE__ */ jsxRuntimeExports.jsx(Shuffled$4, {}) : /* @__PURE__ */ jsxRuntimeExports.jsx(Vanilla$4, {});
  return /* @__PURE__ */ jsxRuntimeExports.jsx(FairyPool, { children: locations });
};
const Vanilla$3 = () => null;
const Shuffled$3 = () => {
  const anyKong = useAnyKong();
  const inStage = usePlayCaves();
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(jsxRuntimeExports.Fragment, { children: [
...
const CrateLocations$1 = () => {
  const shuffle = useDonkStore(useShallow((state) => state.shuffleCrates));
  const locations = shuffle ? /* @__PURE__ */ jsxRuntimeExports.jsx(Shuffled$3, {}) : /* @__PURE__ */ jsxRuntimeExports.jsx(Vanilla$3, {});
  return /* @__PURE__ */ jsxRuntimeExports.jsx(CratePool, { children: locations });
};
const CavesChecks = () => {
  const inStage = usePlayCaves();
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "grid", children: [
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx(
      CavesCheck,
      {
        ...
        region: "Igloo Area",
        canGetLogic: igloo && dk2 && bongos && strong,
        canGetBreak: igloo && dk2 && bongos
      }
    ),
    /* @__PURE__ */ jsxRuntimeExports.jsx(
      CavesCheck,
      {
        ...
        region: "Cabins Area",
        canGetLogic: inStage && dk2 && bongos && slam != 0
      }
    ),
    /* @__PURE__ */ jsxRuntimeExports.jsx(
      CavesCheck,
      {
        ...
        region: "Cabins Area",
        canGetLogic: inStage && dk2 && bongos && anyGun && homing,
        canGetBreak: inStage && dk2 && bongos && anyGun
      }
    ),
    /* @__PURE__ */ jsxRuntimeExports.jsx(
      CavesCheck,
      {
        ...
        region: "Main Caves Area",
        canGetLogic: inStage && diddy && rocket,
        canGetBreak: inStage && (dk2 || tiny && twirl)
      }
    ),
    /* @__PURE__ */ jsxRuntimeExports.jsx(
      CavesCheck,
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx(
      CavesCheck,
      {
        ...
        canGetBreak: inStage && lanky && trombone && (sprint || dk2)
      }
    ),
    /* @__PURE__ */ jsxRuntimeExports.jsx(
      CavesCheck,
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx(CavesShops, {})
  ] });
};
...
const TinyMedal = () => {
  const inStage = usePlayCastle();
  const canSlam = useSlamCastle();
  const [cbCount, coloredBananaShuffle, kong, gun, crystal, pad, diddy, lanky, grape] = useDonkStore(
    useShallow((state) => [
      state.cbCount,
      state.shuffleColoredBananas,
      state.tiny,
...
const DirtLocations = () => {
  const shuffle = useDonkStore(useShallow((state) => state.shuffleDirt));
  const locations = shuffle ? /* @__PURE__ */ jsxRuntimeExports.jsx(ShuffledDirtLocations, {}) : /* @__PURE__ */ jsxRuntimeExports.jsx(VanillaDirtLocations, {});
  return /* @__PURE__ */ jsxRuntimeExports.jsx(RainbowCoinPool, { children: locations });
};
const Vanilla$2 = () => {
  const inStage = usePlayCastle();
...
const KasplatLocations = () => {
  const shuffle = useDonkStore(useShallow((state) => state.shuffleKasplats));
  const locations = shuffle ? /* @__PURE__ */ jsxRuntimeExports.jsx(Shuffled$2, {}) : /* @__PURE__ */ jsxRuntimeExports.jsx(Vanilla$2, {});
  return /* @__PURE__ */ jsxRuntimeExports.jsx(KasplatPool, { children: locations });
};
const Vanilla$1 = () => {
  const inStage = usePlayCastle();
...
const FairyLocations = () => {
  const shuffle = useDonkStore(useShallow((state) => state.shuffleFairies));
  const locations = shuffle ? /* @__PURE__ */ jsxRuntimeExports.jsx(Shuffled$1, {}) : /* @__PURE__ */ jsxRuntimeExports.jsx(Vanilla$1, {});
  return /* @__PURE__ */ jsxRuntimeExports.jsx(FairyPool, { children: locations });
};
const Vanilla = () => {
  const inStage = usePlayCastle();
...
const CrateLocations = () => {
  const shuffle = useDonkStore(useShallow((state) => state.shuffleCrates));
  const locations = shuffle ? /* @__PURE__ */ jsxRuntimeExports.jsx(Shuffled, {}) : /* @__PURE__ */ jsxRuntimeExports.jsx(Vanilla, {});
  return /* @__PURE__ */ jsxRuntimeExports.jsx(CratePool, { children: locations });
};
const CastleChecks = () => {
  const inStage = usePlayCastle();
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "grid", children: [
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx(
      CastleCheck,
      {
        ...
        region: "Castle Underground",
        canGetLogic: inStage && dk2 && coconut && grab
      }
    ),
    /* @__PURE__ */ jsxRuntimeExports.jsx(
      CastleCheck,
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx(
      CastleCheck,
      {
        ...
        canGetBreak: inStage && lanky && grape && (sprint || dk2 || diddy)
      }
    ),
    /* @__PURE__ */ jsxRuntimeExports.jsx(
      CastleCheck,
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx(
      CastleCheck,
      {
        ...
        canGetBreak: inStage && (tiny && feather || lanky && grape) && canSlam && (dk2 || tiny && twirl)
      }
    ),
    /* @__PURE__ */ jsxRuntimeExports.jsx(
      CastleCheck,
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx(CastleShops, {})
  ] });
};
const genDropDowns = () => {
...
const FoolishDropDown = (props) => {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsx(jsxRuntimeExports.Fragment, { children: /* @__PURE__ */ jsxRuntimeExports.jsx(
    "select",
    {
      id: `fool-{check}`,
      value: check,
      onChange: (e2) => setFool(props.id, e2.target.value),
      children: genDropDowns()
    }
  ) });
};
const FoolishHints = () => {
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("section", { className: "foolish-section", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx("h3", { children: "Foolish" }),
    /* @__PURE__ */ jsxRuntimeExports.jsxs("section", { className: "foolish-drops", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx(FoolishDropDown, { id: "fool01" }),
      /* @__PURE__ */ jsxRuntimeExports.jsx(FoolishDropDown, { id: "fool02" }),
      /* @__PURE__ */ jsxRuntimeExports.jsx(FoolishDropDown, { id: "fool03" }),
      /* @__PURE__ */ jsxRuntimeExports.jsx(FoolishDropDown, { id: "fool04" }),
      /* @__PURE__ */ jsxRuntimeExports.jsx(FoolishDropDown, { id: "fool05" }),
      /* @__PURE__ */ jsxRuntimeExports.jsx(FoolishDropDown, { id: "fool06" }),
      /* @__PURE__ */ jsxRuntimeExports.jsx(FoolishDropDown, { id: "fool07" }),
      /* @__PURE__ */ jsxRuntimeExports.jsx(FoolishDropDown, { id: "fool08" }),
      /* @__PURE__ */ jsxRuntimeExports.jsx(FoolishDropDown, { id: "fool09" }),
      /* @__PURE__ */ jsxRuntimeExports.jsx(FoolishDropDown, { id: "fool10" })
    ] })
  ] });
};
const ResetTracker = () => {
  return /* @__PURE__ */ jsxRuntimeExports.jsx("section", { children: /* @__PURE__ */ jsxRuntimeExports.jsx(
    "button",
    {
      type: "button",
      onClick: (e2) => {
      ...
      Modal,
      {
        ...
        children: /* @__PURE__ */ jsxRuntimeExports.jsx("section", { className: "modal-settings", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("section", { className: "pool", children: [
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsxs(jsxRuntimeExports.Fragment, { children: [
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsx(SimpleIcon, { imgUrl: shopIcon, storeKey: "poolShops" }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("p", { children: "Tough Golden Bananas?" }),
            /* @__PURE__ */ jsxRuntimeExports.jsx(SimpleIcon, { imgUrl: toughBananaIcon, storeKey: "poolToughBananas" }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("p", { children: "Battle Crowns?" }),
            /* @__PURE__ */ jsxRuntimeExports.jsx(SimpleIcon, { imgUrl: crownIcon, storeKey: "poolCrowns" }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("p", { children: "Blueprints?" }),
            /* @__PURE__ */ jsxRuntimeExports.jsx(SimpleIcon, { imgUrl: blueprintIcon, storeKey: "poolBlueprints" }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("p", { children: "Boss Keys?" }),
            /* @__PURE__ */ jsxRuntimeExports.jsx(SimpleIcon, { imgUrl: keyIcon, storeKey: "poolKeys" }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("p", { children: "Banana Medals?" }),
            /* @__PURE__ */ jsxRuntimeExports.jsx(SimpleIcon, { imgUrl: bananaMedalIcon, storeKey: "poolBananaMedals" }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("p", { children: "Company Coins?" }),
            /* @__PURE__ */ jsxRuntimeExports.jsx(SimpleIcon, { imgUrl: companyCoinIcon, storeKey: "poolCompanyCoins" }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("p", { children: "Banana Fairies?" }),
            /* @__PURE__ */ jsxRuntimeExports.jsx(SimpleIcon, { imgUrl: fairyIcon, storeKey: "poolFairies" }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("p", { children: "Rainbow Coins?" }),
            /* @__PURE__ */ jsxRuntimeExports.jsx(SimpleIcon, { imgUrl: rainbowCoinIcon, storeKey: "poolRainbowCoins" }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("p", { children: "Melon Crates?" }),
            /* @__PURE__ */ jsxRuntimeExports.jsx(SimpleIcon, { imgUrl: melonIcon, storeKey: "poolCrates" }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("p", { children: "Pearls & Bean?" }),
            /* @__PURE__ */ jsxRuntimeExports.jsx(SimpleIcon, { imgUrl: beanIcon, storeKey: "poolMisc" })
          ] }),
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsxs(jsxRuntimeExports.Fragment, { children: [
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsx(CountSelector, { imgUrl: bananaMedalIcon, storeKey: "jetpacCount", maxValue: 40 }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("p", { children: "Bananas for Medal?" }),
            /* @__PURE__ */ jsxRuntimeExports.jsx(CountSelector, { imgUrl: bananaIcon, storeKey: "cbCount", maxValue: 100 }),
            /* @__PURE__ */ jsxRuntimeExports.jsxs("p", { children: [
              "Fairies for ",
              /* @__PURE__ */ jsxRuntimeExports.jsx("span", { title: "Banana Fairy Island", children: "BFI" }),
              "?"
            ] }),
            /* @__PURE__ */ jsxRuntimeExports.jsx(CountSelector, { imgUrl: fairyIcon, storeKey: "fairyCount", maxValue: 20 })
          ] }),
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsxs(jsxRuntimeExports.Fragment, { children: [
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsx(SimpleIcon, { imgUrl: switchsanityIcon, storeKey: "isSwitchsanity" }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("p", { children: "Hard Shooting?" }),
            /* @__PURE__ */ jsxRuntimeExports.jsx(SimpleIcon, { imgUrl: hardShootIcon, storeKey: "hardShooting" })
          ] }),
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsxs(jsxRuntimeExports.Fragment, { children: [
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsx(SimpleIcon, { imgUrl: bananaIcon, storeKey: "shuffleColoredBananas" }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("p", { children: "Kasplats?" }),
            /* @__PURE__ */ jsxRuntimeExports.jsx(SimpleIcon, { imgUrl: kasplatIcon, storeKey: "shuffleKasplats" }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("p", { children: "Fairies?" }),
            /* @__PURE__ */ jsxRuntimeExports.jsx(SimpleIcon, { imgUrl: fairyIcon, storeKey: "shuffleFairies" }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("p", { children: "Dirt Patches?" }),
            /* @__PURE__ */ jsxRuntimeExports.jsx(SimpleIcon, { imgUrl: dirtIcon, storeKey: "shuffleDirt" }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("p", { children: "Battle Arenas?" }),
            /* @__PURE__ */ jsxRuntimeExports.jsx(SimpleIcon, { imgUrl: arenaIcon, storeKey: "shuffleArenas" }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("p", { children: "Melon Crates?" }),
            /* @__PURE__ */ jsxRuntimeExports.jsx(SimpleIcon, { imgUrl: melonIcon, storeKey: "shuffleCrates" })
          ] })
        ] }) })
      }
    )
...
function App() {
  return /* @__PURE__ */ jsxRuntimeExports.jsx(jsxRuntimeExports.Fragment, { children: /* @__PURE__ */ jsxRuntimeExports.jsxs("main", { children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs("article", { children: [
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsx(FoolishHints, {}),
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx("article", { children: /* @__PURE__ */ jsxRuntimeExports.jsxs(Tabs, { children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs(TabList, { children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx(Tab, { children: "Isles & Helm" }),
