...
const useLlamaCrate = () => useAztecLlamaTemple();
const useLlamaOutsideCrate = () => {
  const back = useAztecBack();
  const rocket = useRocket();
  return {
    in: rocket && back.in,
...
const useDkDungeonGb = () => {
  const dk2 = useDk();
  const slam = useSlamCastle();
  return usePlayCastle() && dk2 && slam;
};
const useLankyRoomGb = () => {
  const inStage = usePlayCastle();
  const slam = useSlamCastle();
  const grape = useGrape();
...
const useLankyMausoleumGb = () => {
  ...
  return {
    ...
    out: inStage && grape && (sprint || dk2 || diddy)
  };
};
...
const useTinyMausoleumGb = () => {
  ...
  return {
    ...
    out: inStage && (feather || grape) && canSlam && (dk2 || twirl)
  };
};
...
const useGeneralDirt$6 = () => {
  const inStage = useGeneralThing$4();
...
const useDiddyStorageGb = () => {
  ...
  return {
    ...
    out: logicBreak(hut) && canSlam && diddy && (autoBonus || vine || dk2 || chunky)
  };
};
...
const useDkMushGb = () => {
  ...
  return useSlamForest() && inStage && allGun2;
};
const useDkMillGb = () => {
  const inStage = usePlayForest();
  const day = useForestDay();
...
const useForestBarn = () => {
  ...
  return {
    ...
    out: inStage && logicBreak(night) && dk2 && canSlam
  };
};
const useDkBarnGb = () => {
...
const useGalleonLighthouseInside = () => {
  const canSlam = useSlamGalleon();
  const lighthousePlatform = useGalleonLighthousePlatform();
  const dk2 = useDk();
  return {
    in: lighthousePlatform.in && canSlam && dk2,
    out: lighthousePlatform.out && canSlam && dk2
  };
};
...
const useChunkySeasickGb = () => {
  const lighthouse = useGalleonLighthouseArea();
  const punch = usePunch();
  const slam = useSlam();
  return lighthouse && punch && slam;
};
const useChunky5DoorShipGb = () => {
  const lighthouse = useGalleonLighthouseArea();
  const outskirts = useGalleonOutskirts();
  const dive = useDive();
  const triangle = useTriangle();
...
const useDk5DoorShipGb = () => {
  const outskirts = useGalleonOutskirts();
  const bongos = useBongos();
  const dive = useDive();
  return outskirts && bongos && dive;
};
const useLankyChestGb = () => {
  const lighthouse = useGalleonLighthouseArea();
  const lanky = useLanky();
  const dive = useDiddy();
  return lighthouse && lanky && dive;
};
const useLankyGoldGb = () => {
  const treasure = useGalleonTreasureRoom();
  const balloon = useBalloon();
  const highGrab = useHighGrab();
  return {
...
const useGeneralOutskirts = () => {
  const inStage = useGalleonOutskirts();
  return useAnyKong() && inStage;
};
const useLighthouseDirt = () => {
...
const useChunkyUndergroundGb = () => {
  ...
  return {
    ...
    out: under && (dk2 || twirl || (tiny || diddy) && vine)
  };
};
...
const VanillaDirtLocations$7 = () => {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(jsxRuntimeExports.Fragment, { children: [
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx(IslesCheck, { id: 72, name: "Isles Dirt Back of Prison", region: "Krem Isle", canGetLogic: dirt }),
    /* @__PURE__ */ jsxRuntimeExports.jsx(
      IslesCheck,
      {
        id: 73,
...
const Vanilla$D = () => {
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(jsxRuntimeExports.Fragment, { children: [
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx(IslesCheck, { id: 83, name: "Isles Krem Fairy", region: "Krem Isle", canGetLogic: useKremFairy() })
  ] });
};
const Shuffled$D = () => {
...
const Vanilla$A = () => {
  return /* @__PURE__ */ jsxRuntimeExports.jsx(JapesCheck, { id: 1090, name: "Japes Arena", region: "Japes Hillside", canGetLogic: useArena() });
};
const Shuffled$A = () => {
  return /* @__PURE__ */ jsxRuntimeExports.jsx(jsxRuntimeExports.Fragment, { children: /* @__PURE__ */ jsxRuntimeExports.jsx(JapesCheck, { id: 1190, name: "Japes Arena", canGetLogic: useArena() }) });
};
...
const Shuffled$z = () => {
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(jsxRuntimeExports.Fragment, { children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx(JapesCheck, { id: 1260, name: "Japes Crate Location #1 (maybe)", canGetLogic: useArena() }),
    /* @__PURE__ */ jsxRuntimeExports.jsx(JapesCheck, { id: 1261, name: "Japes Crate Location #2 (maybe)", canGetLogic: useArena() })
  ] });
};
...
const ShuffledDirtLocations$6 = () => {
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(jsxRuntimeExports.Fragment, { children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx(JapesCheck, { id: 1270, name: "Japes Dirt Location #1", canGetLogic: useGeneralDirt$1() }),
    /* @__PURE__ */ jsxRuntimeExports.jsx(JapesCheck, { id: 1271, name: "Japes Dirt Location #2", canGetLogic: useGeneralDirt$1() })
  ] });
};
...
const Shuffled$y = () => {
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(jsxRuntimeExports.Fragment, { children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx(JapesCheck, { id: 1280, name: "Japes Fairy Location #1", canGetLogic: useGeneralFairy$1() }),
    /* @__PURE__ */ jsxRuntimeExports.jsx(JapesCheck, { id: 1281, name: "Japes Fairy Location #2", canGetLogic: useGeneralFairy$1() })
  ] });
};
...
const Shuffled$x = () => {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(jsxRuntimeExports.Fragment, { children: [
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx(JapesCheck, { id: 1252, name: "Japes Kasplat Location #3", canGetLogic: kasplat }),
    /* @__PURE__ */ jsxRuntimeExports.jsx(JapesCheck, { id: 1253, name: "Japes Kasplat Location #4", canGetLogic: kasplat }),
    /* @__PURE__ */ jsxRuntimeExports.jsx(JapesCheck, { id: 1254, name: "Japes Kasplat Location #5", canGetLogic: kasplat })
  ] });
};
...
const Shuffled$v = () => {
  const thing = useGeneralThing$5();
  return /* @__PURE__ */ jsxRuntimeExports.jsx(jsxRuntimeExports.Fragment, { children: /* @__PURE__ */ jsxRuntimeExports.jsx(AztecCheck, { id: 2190, name: "Aztec Arena", canGetLogic: thing.in, canGetBreak: thing.out }) });
};
...
const Shuffled$t = () => {
  const fairyLogic = useGeneralFairy$6();
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(jsxRuntimeExports.Fragment, { children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx(
      AztecCheck,
      {
...
const Vanilla$q = () => {
  return /* @__PURE__ */ jsxRuntimeExports.jsx(FactoryCheck, { id: 3090, name: "Factory Arena", region: "R&D Area", canGetLogic: useArena$3() });
};
const Shuffled$q = () => {
  return /* @__PURE__ */ jsxRuntimeExports.jsx(jsxRuntimeExports.Fragment, { children: /* @__PURE__ */ jsxRuntimeExports.jsx(FactoryCheck, { id: 3190, name: "Factory Arena", canGetLogic: useGeneralThing$2() }) });
};
...
const Shuffled$n = () => {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(jsxRuntimeExports.Fragment, { children: [
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx(FactoryCheck, { id: 3252, name: "Factory Kasplat Location #3", canGetLogic: kasplat }),
    /* @__PURE__ */ jsxRuntimeExports.jsx(FactoryCheck, { id: 3253, name: "Factory Kasplat Location #4", canGetLogic: kasplat }),
...
const Shuffled$l = () => {
  return /* @__PURE__ */ jsxRuntimeExports.jsx(jsxRuntimeExports.Fragment, { children: /* @__PURE__ */ jsxRuntimeExports.jsx(GalleonCheck, { id: 4190, name: "Galleon Arena", canGetLogic: useGeneralThing() }) });
};
...
const Shuffled$i = () => {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(jsxRuntimeExports.Fragment, { children: [
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx(GalleonCheck, { id: 4252, name: "Galleon Kasplat Location #3", canGetLogic: thing }),
    /* @__PURE__ */ jsxRuntimeExports.jsx(GalleonCheck, { id: 4253, name: "Galleon Kasplat Location #4", canGetLogic: thing }),
...
const Shuffled$g = () => {
  const thing = useGeneralThing$1();
  return /* @__PURE__ */ jsxRuntimeExports.jsx(jsxRuntimeExports.Fragment, { children: /* @__PURE__ */ jsxRuntimeExports.jsx(ForestCheck, { id: 5190, name: "Forest Arena", canGetLogic: thing }) });
};
...
const Shuffled$f = () => {
  const thing = useGeneralThing$1();
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(jsxRuntimeExports.Fragment, { children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx(JapesCheck, { id: 1260, name: "Japes Crate Location #1 (maybe)", canGetLogic: thing }),
    /* @__PURE__ */ jsxRuntimeExports.jsx(JapesCheck, { id: 1261, name: "Japes Crate Location #2 (maybe)", canGetLogic: thing })
  ] });
};
...
const Vanilla$b = () => {
  return /* @__PURE__ */ jsxRuntimeExports.jsx(CavesCheck, { id: 6090, name: "Caves Arena", region: "Cabins Area", canGetLogic: useDkRotateGb() });
};
const Shuffled$b = () => {
  return /* @__PURE__ */ jsxRuntimeExports.jsx(jsxRuntimeExports.Fragment, { children: /* @__PURE__ */ jsxRuntimeExports.jsx(CavesCheck, { id: 6190, name: "Caves Arena", canGetLogic: useGeneralThing$3() }) });
};
...
const Shuffled$9 = () => {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(jsxRuntimeExports.Fragment, { children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx(CavesCheck, { id: 6280, name: "Caves Fairy Location #1", canGetLogic: thing }),
    /* @__PURE__ */ jsxRuntimeExports.jsx(CavesCheck, { id: 6281, name: "Caves Fairy Location #2", canGetLogic: thing })
  ] });
};
...
const Vanilla$8 = () => {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(jsxRuntimeExports.Fragment, { children: [
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx(CavesCheck, { id: 6053, name: "Caves Kasplat Cabins", region: "Cabins Area", canGetLogic: thing }),
    /* @__PURE__ */ jsxRuntimeExports.jsx(CavesCheck, { id: 6054, name: "Caves Kasplat Igloo", region: "Igloo Area", canGetLogic: thing })
  ] });
};
const Shuffled$8 = () => {
  const thing = useGeneralThing$3();
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(jsxRuntimeExports.Fragment, { children: [
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx(CavesCheck, { id: 6252, name: "Caves Kasplat Location #3", canGetLogic: thing }),
    /* @__PURE__ */ jsxRuntimeExports.jsx(CavesCheck, { id: 6253, name: "Caves Kasplat Location #4", canGetLogic: thing }),
    /* @__PURE__ */ jsxRuntimeExports.jsx(CavesCheck, { id: 6254, name: "Caves Kasplat Location #5", canGetLogic: thing })
  ] });
};
...
const DkBananas$1 = () => {
  const cabinGb = useCavesDkCabinBee();
...
const Shuffled$6 = () => {
  return /* @__PURE__ */ jsxRuntimeExports.jsx(jsxRuntimeExports.Fragment, { children: /* @__PURE__ */ jsxRuntimeExports.jsx(CastleCheck, { id: 7190, name: "Castle Arena", canGetLogic: useGeneralThing$4() }) });
};
...
const Shuffled$5 = () => {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(jsxRuntimeExports.Fragment, { children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx(CastleCheck, { id: 7260, name: "Castle Crate Location #1 (maybe)", canGetLogic: thing }),
    /* @__PURE__ */ jsxRuntimeExports.jsx(CastleCheck, { id: 7261, name: "Castle Crate Location #2 (maybe)", canGetLogic: thing })
  ] });
};
...
const ShuffledDirtLocations = () => {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(jsxRuntimeExports.Fragment, { children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx(CastleCheck, { id: 7270, name: "Castle Dirt Location #1", canGetLogic: dirt }),
    /* @__PURE__ */ jsxRuntimeExports.jsx(CastleCheck, { id: 7271, name: "Castle Dirt Location #2", canGetLogic: dirt })
  ] });
};
const DirtLocations = () => {
...
const Shuffled$4 = () => {
  const fairy = useGeneralFairy$5();
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(jsxRuntimeExports.Fragment, { children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx(CastleCheck, { id: 7280, name: "Castle Fairy Location #1", canGetLogic: fairy }),
    /* @__PURE__ */ jsxRuntimeExports.jsx(CastleCheck, { id: 7281, name: "Castle Fairy Location #2", canGetLogic: fairy })
  ] });
};
...
const Shuffled$3 = () => {
  const kasplat = useGeneralThing$4();
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(jsxRuntimeExports.Fragment, { children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx(CastleCheck, { id: 7250, name: "Castle Kasplat Location #1", canGetLogic: kasplat }),
    /* @__PURE__ */ jsxRuntimeExports.jsx(CastleCheck, { id: 7251, name: "Castle Kasplat Location #2", canGetLogic: kasplat }),
    /* @__PURE__ */ jsxRuntimeExports.jsx(CastleCheck, { id: 7252, name: "Castle Kasplat Location #3", canGetLogic: kasplat }),
    /* @__PURE__ */ jsxRuntimeExports.jsx(CastleCheck, { id: 7253, name: "Castle Kasplat Location #4", canGetLogic: kasplat }),
    /* @__PURE__ */ jsxRuntimeExports.jsx(CastleCheck, { id: 7254, name: "Castle Kasplat Location #5", canGetLogic: kasplat })
  ] });
};
...
const SwitchsanitySwitch = (props) => {
  ...
  const setting = switchsanitySwitches[props.storeKey] ?? 0;
...
const freeChunky = [unknownIcon$1].concat(allKong);
...
const SwitchsanitySelector = () => {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("section", { className: "switchsanity-settings", children: [
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs("section", { children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx(FreeKongSelector, {}),
      isSwitchsanity ? /* @__PURE__ */ jsxRuntimeExports.jsx(StandardSwitchsanitySelector, {}) : null
    ] })
  ] });
};
const App = () => {
