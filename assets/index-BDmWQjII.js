...
const BananaportSelector = () => {
  ...
  const handleNextLevel = () => {
    setSetting("bananaportOpen", nextPort$1(bananaportOpen));
  };
  const handlePrevLevel = (e2) => {
    e2.preventDefault();
    setSetting("bananaportOpen", prevPort$1(bananaportOpen));
  };
  const handleWheel = (e2) => {
    if (e2.deltaY >= 0) {
      setSetting("bananaportOpen", nextPort$1(bananaportOpen));
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsx("div", { children: /* @__PURE__ */ jsxRuntimeExports.jsx(
    "img",
    {
      ...
      src: portToIcon$1(bananaportOpen),
      onClick: handleNextLevel,
...
const useSlamLevel = (level) => {
  ...
  const [level1, level2, level3, level4, level5, level6, level7, level8, slam, progressiveSlams] = useDonkStore(
    useShallow((state) => [
      state.level1,
      state.level2,
      state.level3,
...
const useAztecBack = () => {
  ...
  return {
    ...
    out: logicBreak(aztecFront) && (backGateOpen || bananaport == 2 || musicSwitch && (diddy || tiny))
  };
};
...
const CrateLocations$7 = () => {
  ...
  const locations = shuffle ? /* @__PURE__ */ jsxRuntimeExports.jsx(Shuffled$n, {}) : /* @__PURE__ */ jsxRuntimeExports.jsx(Vanilla$n, {});
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(jsxRuntimeExports.Fragment, { children: [
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx(
      CastleCheck,
      {
        ...
        canGetBreak: inStage && lanky && (grape || feather) && (sprint || dk2 || diddy)
      }
    ),
    /* @__PURE__ */ jsxRuntimeExports.jsx(
      CastleCheck,
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(jsxRuntimeExports.Fragment, { children: [
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx(
      CavesCheck,
      {
        ...
        canGetBreak: inStage && trombone && (sprint || dk2 || diddy)
      }
    )
  ] });
};
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(jsxRuntimeExports.Fragment, { children: [
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx(
      ForestCheck,
      {
        ...
        region: "Forest Mills",
        canGetLogic: inStage && (forestTime == 2 && (mini && feather || punch && pineapple) || night.in && punch && mini && feather),
...
const DirtAztec = () => {
  ...
  const boulderTech = useBoulderTech();
  const shockwave = useShockwave();
  const [dk2, diddy, rocket, tiny, twirl, dirtShuffle, rainbowCoinShuffle] = useDonkStore(
    useShallow((state) => [
      state.moves.dk,
      state.moves.diddy,
      state.moves.rocket,
